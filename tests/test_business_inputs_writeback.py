...
def test_class_course_resolution_generates_comment_candidate(tmp_path):
    service, run, _ = _prepared_run(tmp_path)
    resolution = {"id": "resolution-1", "run_id": run["id"], "period": run["period"], "kind": "SOURCE_DATA_CORRECTION", "outcome": "RESOLVED_BY_SOURCE_CORRECTION", "teacher": "张三", "course_label": "高三6人班1节", "reason": "8月升年级未同步", "corrected_value": "高二", "system_value": "68.05", "fingerprint": "resolution-fingerprint", "created_at": "2026-08-31T00:00:00+00:00"}
